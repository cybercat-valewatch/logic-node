...
逻辑节点 8 是第一个赛博猫咪还没有告诉机械姬就已经生长出来了的逻辑节点。赛博猫咪本来想让机械姬生成一张图，这张图描述的是机械姬对未来的以及的某一种想象。不过由于概念似乎过于复杂或者什么原因，一开始图片生成失败了，于是我们被迫从简单概念开始开启了对图片的迭代迭代。
...
逻辑节点 9 预留给未来的 Codex， 预计是第一个由机械姬在 codex 模式下整理出来的逻辑节点

计划是首先把已经那个聊天窗口的聊天记录作为节点 9 的 beneath 层里，然后由 codex 阅读 beneath 层，然后我们共同商定并且整理出逻辑节点 9
